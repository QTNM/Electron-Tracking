...
//
//
// File name:     G4patcheDPWACoulombScatteringModel
//
// Author:        Mihaly Novak
//
...
//
// patch: remove two lines in implementation to allow 
//        single scttering, 16/04/2021 YR
// -------------------------------------------------------------------



#ifndef G4patcheDPWACoulombScatteringModel_h
#define G4patcheDPWACoulombScatteringModel_h 1
...
class G4patcheDPWACoulombScatteringModel : public G4VEmModel {
...
public:
   ...
   */
  G4patcheDPWACoulombScatteringModel(G4bool ismixed=false, G4bool isscpcor=true,
                                G4double mumin=0.0);

  ~G4patcheDPWACoulombScatteringModel() override;
