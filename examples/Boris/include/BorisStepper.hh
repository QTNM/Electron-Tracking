...
// --------------------------------------------------------------------
#ifndef BORISSTEPPER_HH
#define BORISSTEPPER_HH
...
class BorisStepper : public G4MagHelicalStepper
{
  public:  // with description

    BorisStepper(G4Mag_EqRhs* EqRhs);
    ~BorisStepper();
  
    BorisStepper(const BorisStepper&) = delete;
    BorisStepper& operator=(const BorisStepper&) = delete;
