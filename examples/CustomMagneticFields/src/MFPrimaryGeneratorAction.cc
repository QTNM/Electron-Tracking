...
MFPrimaryGeneratorAction::MFPrimaryGeneratorAction()
...
void MFPrimaryGeneratorAction::GeneratePrimaries(G4Event* event)
{
...
void MFPrimaryGeneratorAction::DefineCommands()
{
  // Define /MF/generator command directory using generic messenger class
  fMessenger =
    new G4GenericMessenger(this, "/MF/generator/", "Primary generator control");
