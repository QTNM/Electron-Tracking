...
MFGasSD::MFGasSD(const G4String& name,
...
void MFGasSD::Initialize(G4HCofThisEvent* hce)
{
  // Create hits collection

  fHitsCollection 
    = new MFGasHitsCollection(SensitiveDetectorName, collectionName[0]); 
...
G4bool MFGasSD::ProcessHits(G4Step* aStep, 
                            G4TouchableHistory*)
{  
  // energy deposit
...
void MFGasSD::EndOfEvent(G4HCofThisEvent*)
{
  if ( verboseLevel>1 ) { 
