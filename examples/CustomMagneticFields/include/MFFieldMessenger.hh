...
#ifndef MFFieldMessenger_h
#define MFFieldMessenger_h 1
...
class MFFieldMessenger: public G4UImessenger
{
  public:
    MFFieldMessenger(MFMagneticFieldSetup* );
    virtual ~MFFieldMessenger();

    virtual void SetNewValue(G4UIcommand*, G4String);
 
  private:

    MFMagneticFieldSetup*      fElFieldSetup;
