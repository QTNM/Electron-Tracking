...
PEGasSD::PEGasSD(const G4String& name,
...
void PEGasSD::Initialize(G4HCofThisEvent* hce)
{
  // Create hits collection

  fHitsCollection 
    = new PEGasHitsCollection(SensitiveDetectorName, collectionName[0]); 
...
G4bool PEGasSD::ProcessHits(G4Step* aStep, 
                            G4TouchableHistory*)
{  
...
void PEGasSD::EndOfEvent(G4HCofThisEvent*)
{
  if ( verboseLevel>1 ) { 
